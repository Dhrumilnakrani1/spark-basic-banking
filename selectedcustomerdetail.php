    ...
    else if($amount > $sql1['currentbalance']) 
    {
        ...
        echo '</script>';
         ...
         echo "</script>";
                ...
                $sql = "INSERT INTO transferdata(`moneysender`, `moneyreceiver`, `currentbalance`) VALUES ('$moneysender','$moneyreceiver','$amount')";
                $query=mysqli_query($conn,$sql);

                if($query){
                     echo "<script> alert('Transaction Successful');
                                     window.location='transfercustomermoney.php';
                           </script>";
        ...
        <select name="to" class="form-control" required>
            ...
            ?>
                <option class="table" value="<?php echo $rows['id'];?>" >
                    ...
                    <?php echo $rows['customer_name'] ;?> (currentbalance: 
