            ...
            <div class="row">
                <div class="col">
                    ...
                    <table class="table table-hover table-sm table-striped table-condensed table-bordered">
                        <thead>
                            ...
                            <th scope="col" class="text-center py-2">customer_email</th>
                            <th scope="col" class="text-center py-2">customer_email</th>
                ...
                ?>
                    <tr>
                        ...
                        <td class="py-2"><?php echo $rows['customer_email']?></td>
                        <td><a href="selectedcustomerdetail.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn">Show Details/Transfer</button></a></td> 
                    </tr>
                <?php
                    }
                ?>
